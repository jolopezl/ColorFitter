...
// Example code
//     gMinuit->GetParameter(0,fpar[0],ferr[0]);
//     gMinuit->GetParameter(1,fpar[1],ferr[1]);
//     gMinuit->GetParameter(2,fpar[2],ferr[2]);
...
//     gMinuit->mnerrs(0,eplus[0],eminus[0],eparab[0],ecorr[0]);
//     gMinuit->mnerrs(1,eplus[1],eminus[1],eparab[1],ecorr[1]);
//     gMinuit->mnerrs(2,eplus[2],eminus[2],eparab[2],ecorr[2]);
