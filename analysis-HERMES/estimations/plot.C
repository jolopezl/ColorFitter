void plot()
{
  ...
  TGraph* g00 = new TGraph(8, nu, z00);
  g00->SetTitle("Plot of Production Length;#nu [GeV];Production Length [fm]");
  g00->SetMarkerColor(kRed);
  TGraph* g01 = new TGraph(8, nu, z01);
  g01->SetTitle("Plot of Production Length;#nu [GeV];Production Length [fm]");
  g01->SetMarkerColor(kRed);
  TGraph* g02 = new TGraph(8, nu, z02);
  g02->SetTitle("Plot of Production Length;#nu [GeV];Production Length [fm]");
  g02->SetMarkerColor(kRed);
  TGraph* g03 = new TGraph(8, nu, z03);
  g03->SetTitle("Plot of Production Length;#nu [GeV];Production Length [fm]");
  g03->SetMarkerColor(kRed);
  TGraph* g10 = new TGraph(8, nu, z10);
  g10->SetTitle("Plot of Production Length;#nu [GeV];Production Length [fm]");
  g10->SetMarkerColor(kBlue);
  TGraph* g11 = new TGraph(8, nu, z11);
  g11->SetTitle("Plot of Production Length;#nu [GeV];Production Length [fm]");
  g11->SetMarkerColor(kBlue);
  TGraph* g12 = new TGraph(8, nu, z12);
  g12->SetTitle("Plot of Production Length;#nu [GeV];Production Length [fm]");
  g12->SetMarkerColor(kBlue);
  TGraph* g13 = new TGraph(8, nu, z13);
  g13->SetTitle("Plot of Production Length;#nu [GeV];Production Length [fm]");
  ...
  g03->Draw("PSAME");
  c1->cd(1);
  myText(0.31, 0.8, kBlack, "z-bin #1", 0.05);
  c1->cd(2);
  myText(0.05, 0.8, kBlack, "z-bin #2", 0.05);
  c1->cd(3);
  myText(0.31, 0.9, kBlack, "z-bin #3", 0.05);
  c1->cd(4);
  myText(0.05, 0.9, kBlack, "z-bin #4", 0.05);
