void PlotMultiplicity()
{
  ...
  ff_Ne_tot->SetLineStyle(kDashed);
  ff_Ne_tot->SetLineWidth(2);
  ff_Kr_tot->SetLineStyle(kDashed);
  ff_Kr_tot->SetLineWidth(2);
  ff_Xe_tot->SetLineStyle(kDashed);
  ff_Xe_tot->SetLineWidth(2);
  ...
  ff_Ne_tot_up->SetLineStyle(kDashed);
  ff_Ne_tot->SetLineWidth(2);
  ff_Kr_tot_up->SetLineStyle(kDashed);
  ff_Kr_tot->SetLineWidth(2);
  ff_Xe_tot_up->SetLineStyle(kDashed);
  ff_Xe_tot->SetLineWidth(2);
  ...
  ff_Ne_tot_down->SetLineStyle(kDashed);
  ff_Ne_tot->SetLineWidth(2);
  ff_Kr_tot_down->SetLineStyle(kDashed);
  ff_Kr_tot->SetLineWidth(2);
  ff_Xe_tot_down->SetLineStyle(kDashed);
  ff_Xe_tot->SetLineWidth(2);
