...
values[0].append( array("f",[1.439144346,0.864253491,0.32681158,0.297838138]) ) # rho =  0.0
values[0].append( array("f",[1.583986546,0.997879765,0.377075587,0.321974829]) ) # rho = -0.5
values[0].append( array("f",[1.762583792,1.186225377,0.489355909,0.3710933]) ) # rho = -1.0
