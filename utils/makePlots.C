void makePlots()
{
  ...
  for (int i = 0; i < 12; ++i) {
  std:
    string ifile = "testFit" + models[i] + ".root";
  ...
  auto tg1 = (TGraphErrors*)fin["BL30"]->Get(key2);
  tg1->SetMarkerStyle(20);
  tg1->SetMarkerColor(kAzure);
  tg1->SetLineColor(kAzure);
  auto tg2 = (TGraphErrors*)fin["BL40"]->Get(key2);
  tg2->SetMarkerStyle(24);
  tg2->SetMarkerColor(kAzure - 1);
  tg2->SetLineColor(kAzure - 1);
  auto tg3 = (TGraphErrors*)fin["BL30.fixedLp"]->Get(key2);
  tg3->SetMarkerStyle(21);
  tg3->SetMarkerColor(kOrange);
  tg3->SetLineColor(kOrange);
  auto tg4 = (TGraphErrors*)fin["BL40.fixedLp"]->Get(key2);
  tg4->SetMarkerStyle(25);
  tg4->SetMarkerColor(kOrange - 1);
  tg4->SetLineColor(kOrange - 1);
...
*/
  ...
  fg1->FixParameter(0, 0.938272); // 0.9 GeV
  fg2->SetParName(1, "NU");
  fg2->FixParameter(1, 13.1);
  fg2->SetParName(2, "KAPPA");
  fg2->SetParameter(2, 1.0);
  fg2->SetParName(0, "MP");
  fg2->FixParameter(0, 0.938272); // 0.9 GeV
  fg2->SetParName(1, "NU");
  fg2->FixParameter(1, 13.1);
  fg3->SetParName(2, "KAPPA");
  fg3->SetParameter(2, 1.0);
  fg3->SetParName(0, "MP");
  fg3->FixParameter(0, 0.938272); // 0.9 GeV
  fg3->SetParName(1, "NU");
  fg3->FixParameter(1, 13.1);
  fg3->SetParName(2, "KAPPA");
  fg3->SetParameter(2, 1.0);
  fg4->SetParName(2, "KAPPA");
  fg4->SetParameter(2, 1.0);
  fg4->SetParName(0, "MP");
  fg4->FixParameter(0, 0.938272); // 0.9 GeV
  fg4->SetParName(1, "NU");
  fg4->FixParameter(1, 13.1);
  fg4->SetParName(2, "KAPPA");
  fg4->SetParameter(2, 1.0);
