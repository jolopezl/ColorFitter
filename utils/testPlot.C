void testPlot() {
    ...
    tg_A1->SetMarkerColor(kAzure);     tg_A1->SetLineColor(kAzure);
    tg_A2->SetMarkerColor(kMagenta);     tg_A2->SetLineColor(kMagenta);
    tg_A3->SetMarkerColor(kOrange);     tg_A3->SetLineColor(kOrange);
    ...
    tg_lp->SetMarkerStyle(kFullCircle); tg_lp->SetMarkerColor(kBlack); tg_lp->SetLineColor(kBlack);
    tg_c1->SetMarkerStyle(kFullCircle); tg_c1->SetMarkerColor(kRed); tg_c1->SetLineColor(kRed);
    tg_c2->SetMarkerStyle(kFullCircle); tg_c2->SetMarkerColor(kBlue); tg_c2->SetLineColor(kBlue);
    // tg_c1->Draw("APE");
    tg_c2->Draw("APE");
    tg_lp->Draw("PSAME");
